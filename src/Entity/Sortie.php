...
class Sortie
{
     ...
     * @ORM\Column(type="datetime")
     */
    private $miseajourcreationsortie;
    ...
    /**
     * @ORM\OneToMany(targetEntity=Information::class, mappedBy="sorties")
     */
    private $information;
    ...
    public function getMiseajourcreationsortie(): ?\DateTimeInterface
    {
        return $this->miseajourcreationsortie;
    }

    public function setMiseajourcreationsortie(\DateTimeInterface $miseajourcreationsortie): self
    {
        $this->miseajourcreationsortie = $miseajourcreationsortie;
    ...
    public function removeInformation(Information $information): self
    {
        if ($this->information->removeElement($information)) {
            ...
            if ($information->getSorties() === $this) {
                $information->setSorties(null);
            }
        }
